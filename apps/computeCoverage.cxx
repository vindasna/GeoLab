...
int main( int argc, char* argv[] )
{
  ...
  if ( index_help > 0 )
  {
    ...
    std::cout << "Function to compute coverage bundle 1 to bundle 2 : \n"
  ...
  if ( is_file( inputBundle1Filename ) && is_file( inputBundle2Filename ) )
  {
    ...
    float bundleCoverage = tmpAtlas.coverageBundle1ToBundle2( bundle1.matrixTracks,
                                                      ...
                                                      thrDistance,
                                                      0 ) ;
    std::cout << bundleCoverage << std::endl ;
